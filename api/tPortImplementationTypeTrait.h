...
struct tPortImplementationTypeTrait
{
  ...
  static const tPortImplementationType type = tIsCheaplyCopiedType<T>::value ? (definitions::cSINGLE_THREADED ? tPortImplementationType::CHEAP_COPY_SINGLE_THREADED :
