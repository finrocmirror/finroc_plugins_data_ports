...
//
//----------------------------------------------------------------------
/*!\file    plugins/data_ports/tPortWrapperBase.h
 *
...
public:
  ...
  typedef core::tAbstractPort::tConnectDirection tConnectDirection;
   ...
   */
  inline void AddAnnotation(core::tAnnotation& ann)
  {
   ...
   */
  inline void ConnectTo(core::tAbstractPort& source, tConnectDirection connect_direction = tConnectDirection::AUTO)
  {
   ...
   * \param connect_direction Direction for connection. "AUTO" should be appropriate for almost any situation. However, another direction may be enforced.
   */
  void ConnectTo(core::tFrameworkElement& src_port_parent, const tString& src_port_name, bool warn_if_not_available = true, tConnectDirection connect_direction = tConnectDirection::AUTO)
  {
   ...
   * \return Annotation. Null if this object has no annotation of specified type attached.
   */
  core::tAnnotation* GetAnnotation(const char* rtti_name) const
  {
   ...
   */
  inline core::tFrameworkElement* GetParent()
  {
   ...
   */
  inline core::tAbstractPort* GetWrapped() const
  {
    return wrapped;
  }
  ...
  bool operator ==(const core::tAbstractPort* p) const
  {
    return wrapped == p;
  }
...
protected:
   ...
   */
  void SetWrapped(core::tAbstractPort* wrapped)
  {
